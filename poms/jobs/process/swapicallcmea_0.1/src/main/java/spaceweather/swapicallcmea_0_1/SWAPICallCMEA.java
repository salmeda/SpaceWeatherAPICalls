...
package spaceweather.swapicallcmea_0_1;
 ...
 * @status DEV
 */
public class SWAPICallCMEA implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (outputpath != null) {
				...
				this.setProperty("outputpath", outputpath.toString());
	...
	private final String jobName = "SWAPICallCMEA";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SWAPICallCMEA.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SWAPICallCMEA.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row13Struct implements routines.system.IPersistableRow<row13Struct> {
		final static byte[] commonByteArrayLock_SPACEWEATHER_SWAPICallCMEA = new byte[0];
		static byte[] commonByteArray_SPACEWEATHER_SWAPICallCMEA = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SPACEWEATHER_SWAPICallCMEA.length) {
					if (length < 1024 && commonByteArray_SPACEWEATHER_SWAPICallCMEA.length == 0) {
						commonByteArray_SPACEWEATHER_SWAPICallCMEA = new byte[1024];
					} else {
						commonByteArray_SPACEWEATHER_SWAPICallCMEA = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SPACEWEATHER_SWAPICallCMEA, 0, length);
				strReturn = new String(commonByteArray_SPACEWEATHER_SWAPICallCMEA, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SPACEWEATHER_SWAPICallCMEA) {
...
///////////////////////    			
				...
				final String decryptedPassword_tDBSP_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[MdZPFMQHouztH094DhVMruRkHda1+32PlSSgI3UEYG6jhj8=]");
				...
				final String decryptedPassword_tDBSP_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[jfO4tQG+jtrEoB51LVNQFn4fX+awUKzgN7c5oVf+rgV7HSs=]");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[r3iYI23vO1S6CKKuW8bydf03nKubCL4taaJQtPnmDIzK4GM=]");
...
// expected response body
							...
							try {
								...
								String url = "https://kauai.ccmc.gsfc.nasa.gov/DONKI/WS/get/CMEAnalysis?";
								// {baseUri}tRESTClient
								...
								if (use_auth_tRESTClient_2 && "SAML".equals("BASIC")) {
									...
									final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
											.decryptPassword("ENC:[0bCDcL26YjnbRbS1KW5E3C4/6G4ps/i9Rc90leuiKDzELCe3]");
								...
								if (use_auth_tRESTClient_2 && "BASIC".equals("BASIC")) {
									...
									final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
											.decryptPassword("ENC:[OzxNWQtKWNLILH0nzAOGwyMS9jmnHfTWBxQQMyZGOWr2Lm+F]");
									...
									final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
											.decryptPassword("ENC:[/28/1SoxWjjqyHViaTVudj9HyeGTGsXxNT1Sbrg3BkAyh/7c]");
								...
								if (!inOSGi) {
									...
									if (use_proxy_tRESTClient_2) {
										...
										final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
												.decryptPassword("ENC:[8OONGyHhi4nmS+8nQwx2IuZYociVItMfdaFpwA==]");
								...
								if (use_auth_tRESTClient_2 && "OIDC_PASSWORD_GRANT".equals("BASIC")) {
									...
									final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
											.decryptPassword("ENC:[VS1WRXYXWU8/cp+/VmbbY4Edu6d093ByclDg7J7NxvEJ1Aud]");
...
// # Output table : 'output'
									...
									output_tmp.filename = context.outputpath + (String) globalMap.get("APIName")
											+ (String) globalMap.get("CallID") + ".json";
									output = output_tmp;
// ###############################
...
///////////////////////    			
				...
				final String decryptedPassword_tDBSP_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[fVEVD8hn7244SkjS2P2E4XlbPMvUFTgRfed53K6svXXubMM=]");
...
///////////////////////    			
				...
				final String decryptedPassword_tDBSP_4 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[OdwWwQv8zOiZvP/IUP0TsMG0NX0HtjDdVQMIholmCRQdQCU=]");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final SWAPICallCMEA SWAPICallCMEAClass = new SWAPICallCMEA();

		int exitCode = SWAPICallCMEAClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SWAPICallCMEA.class.getClassLoader()
					.getResourceAsStream("spaceweather/swapicallcmea_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SWAPICallCMEA.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("outputpath", "id_String");
					context.outputpath = (String) context.getProperty("outputpath");
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("outputpath")) {
				context.outputpath = (String) parentContextMap.get("outputpath");
			}
		}
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SWAPICallCMEA");
		}
...
/************************************************************************************************
 * 183082 characters generated by Talend Open Studio for Big Data on the 31
 * December 2019 12:44:27 GMT
 ************************************************************************************************/